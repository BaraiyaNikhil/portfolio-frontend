...
function Hero() {
  ...
  return (
    <div
      id="hero"
      className="w-full h-full flex flex-col md:flex-row overflow-x-hidden"
    >
      {/* Left Transparent Div (Custom Cursor Active Here) */}
      <div
        id="bg-transparant-div"
      ...
      >
        ...
        <motion.h1
          className="font-['Borel'] text-4xl md:text-7xl lg:text-7xl mb-8 sm:mb-16 max-w-full break-words whitespace-normal leading-tight [text-shadow:_4px_4px_5px_rgba(15,23,42,0.3)]"
        ...
        <motion.h1
          className="font-['Borel'] text-6xl md:text-9xl lg:text-9xlxl mb-4 max-w-full break-words whitespace-normal leading-tight [text-shadow:_4px_4px_5px_rgba(15,23,42,0.3)]"
          variants={itemVariants}
        >
          Nikhil
        </motion.h1>
        ...
        <motion.div className="text-base sm:text-lg mb-3" variants={itemVariants}>
          <p>
            MERN-focused Web Developer skilled in React, Node.js, Express and
            MongoDB, building responsive and user-friendly web applications.
          </p>
          <br />
          <p>
            Motivated, detail-oriented MERN developer who quickly builds
            practical web solutions and thrives in team environments.
          </p>
        </motion.div>
        ...
        <motion.a
          ...
          className="
            disable-cursor-glow
            download inline-flex items-center gap-2
            px-6 py-3
            bg-slate-200/40 backdrop-blur-md
            hover:bg-gradient-to-r hover:from-[var(--my-gradient1)] hover:via-[var(--my-gradient2)] hover:to-[var(--my-gradient3)]
            text-slate-950 font-semibold rounded-lg
      ...
      {/* Custom Cursor (only shows on hover of left transparent div) */}
